...
Grindstaff, B.$^{\ddagger}$, M. E. Mabry, **P. D. Blischak**, M. Quinn, and J. C. Pires. *In press*.
Affordable remote monitoring of plant growth and facilities using Raspberry Pi computers.
*Applications in Plant Sciences*. $^{\ddagger}$Undergraduate author.
...
Titus, B. M., **P. D. Blischak**, and M. Daly. *In press*. Genomic signatures
of sympatric speciation with historical and contemporary gene flow in a tropical
anthozoan. *Molecular Ecology*. 
