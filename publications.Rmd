...
*In review*. Patterns and processes of diploidization in land plants.
[<a href="https://doi.org/10.5281/zenodo.3964504" target="_blank">preprint</a>]

**Blischak, P. D.**, M. S. Barker, and R. N. Gutenkunst. *In revision*.
...
Y. Hao, G. C. Conant, J. C. Pires, and M. S. Barker. *Accepted*.
Genes derived from ancient polyploidy have higher genetic diversity and are associated
with domestication in *Brassica rapa*. *New Phytologist*.
...
**Blischak, P. D.**\*, C. Thompson$^{\ddagger}$, E. Waight$^{\ddagger}$, 
D. Hightower$^{\ddagger}$, L. S. Kubatko, and A. D. Wolfe. Inferring Patterns 
of Hybridizaton and Polyploidy in *Penstemon* subsections *Humiles* and *Proceri* 
(Plantaginaceae). Botany 2018. Rochester, MN.
